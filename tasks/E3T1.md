# E3T1 — Register commands with Telegram

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 QBOT

Register the three commands with Telegram at startup: /start, /quote, /count. Ensure the bot token is provided via the environment variable TELEGRAM_BOT_TOKEN.
