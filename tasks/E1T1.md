# E1T1 — Implement /quote command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 QBOT

Implement the /quote command to atomically increment the global counter in storage, pick one quote at random from the built-in list, and send it as plain text. Write the dialog spec to tests/specs/E1T1.json and append the command to tests/commands.json.
