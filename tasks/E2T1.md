# E2T1 — Initialize SQLite database

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 QBOT

Create the SQLite database file at ./data/quotes.db with a table named 'counter' and a row ('quotes_served', 0). Ensure the table is created if it doesn't exist and the row is inserted if it doesn't exist.
