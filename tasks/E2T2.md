# E2T2 — Implement counter increment logic

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 QBOT

Implement the logic to atomically increment the global counter in the SQLite database using a transaction. Use 'BEGIN; UPDATE counter SET value = value + 1 WHERE name = 'quotes_served'; COMMIT;' followed by a SELECT to retrieve the updated value.
