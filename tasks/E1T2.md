# E1T2 — Implement /count command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 QBOT

Implement the /count command to read the persisted global counter and reply with plain text, e.g. 'Quotes served since launch: 42'. Write the dialog spec to tests/specs/E1T2.json and append the command to tests/commands.json.
